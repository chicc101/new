	...
	public static void main (String[] args)
 {
     ...
     // emp1의 이름, 번호와 나이를 출력한다
		...
		// Employee 객체를 생성하고 emp2가 가리키게 한다
			emp2 = new Employee();// 여기에 코드를 삽입하세요

		// emp2의 이름을 ‘성춘향’으로 변경한다
			emp2.setName("성춘향");// 여기에 코드를 삽입하세요

		// emp2의 번호를 200으로 변경한다
			emp2.setNumber(200);// 여기에 코드를 삽입하세요

		// emp2의 나이를 18로 변경한다
			emp2.setAge(18);// 여기에 코드를 삽입하세요

		// emp2의 이름, 번호와 나이를 출력한다
			System.out.println(emp2);// 여기에 코드를 삽입하세요

     // emp2의 번호를 300으로 변경한다
			emp2.setNumber(300);// 여기에 코드를 삽입하세요

		// emp2의 이름, 번호와 나이를 출력한다
			System.out.println(emp1);// 여기에 코드를 삽입하세요
 }
}